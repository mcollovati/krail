...
/**
 * An interface for I18N Patterns accessed through Class based methods (using [EnumResourceBundle]).  The Guice binding is identified by [ ]
 *
 *
 * Created by David Sowerby on 28/07/15.
 */
interface ClassPatternDao : PatternDao {
     ...
     */
    /**
     *The text file to which you want the [write] method to append a key-value entry
